import { SimulationTypeCustomer, SimulationTypeRideProvider, SimulationTypeRideProviderCompany, SimulationTypeRideProviderPerson } from "./participants"
...
export type AuthenticationServiceParticipantDb = (AuthenticationServiceParticipantDbEntry<Omit<SimulationTypeCustomer, "currentLocation" | "type">>| AuthenticationServiceParticipantDbEntry<Omit<SimulationTypeRideProviderPerson, "currentLocation" | "type">>| AuthenticationServiceParticipantDbEntry<Omit<SimulationTypeRideProviderCompany, "currentLocation" | "type">>)[]
